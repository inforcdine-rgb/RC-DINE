...
export const uploadLogo = (file) => { const data = new FormData(); data.append('logo', file); return api(method.POST, '/website-settings/logo', data); };
export const uploadVideo = (file) => { const data = new FormData(); data.append('video', file); return api(method.POST, '/website-settings/video', data); };
